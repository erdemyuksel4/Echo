...
- **Kamera Mesh Yükü:** 10 kullanıcının hepsi kamera açarsa bant genişliği zorlanabilir.
  - *Önlem:* Çözünürlük 480p24 ile sınırlanır (yaklaşık 300-400 kbps), H.264/VP8 donanım hızlandırması tercih edilir.
- **Auto-Updater İmzası:** Windows SmartScreen imzasız güncellemelerde uyarı verebilir.
  - *Önlem:* `electron-updater` nsis güncellemelerini delta veya tam paket olarak sessiz kurabilir; README ve dokümantasyonda adımlar açıklanır.
